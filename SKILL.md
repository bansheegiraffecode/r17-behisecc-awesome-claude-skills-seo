---
name: "r00-BehiSecc-awesome-claude-skills--seo"
description: >
  📈 SEO & Content Marketing skill suite derived from BehiSecc/awesome-claude-skills.
...
```bash
# Install this skill
cp -r . ~/.claude/skills/r00-BehiSecc-awesome-claude-skills--seo/

# In Claude Code
/read ~/.claude/skills/r00-BehiSecc-awesome-claude-skills--seo/SKILL.md
```
